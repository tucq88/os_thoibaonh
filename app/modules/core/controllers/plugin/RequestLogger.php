 ...
 * @version 	$Id: RequestLogger.php 2373 2010-04-18 05:23:02Z huuphuoc $
 */
...
class Tomato_Modules_Core_Controllers_Plugin_RequestLogger extends Tomato_Core_Controller_Plugin 
{
	...
	public function postDispatch(Zend_Controller_Request_Abstract $request) 
	{
		...
		$log 		= new Tomato_Modules_Core_Model_RequestLog(array(
		...
		$requestLogDao = Tomato_Core_Model_Dao_Factory::getInstance()->setModule('core')->getRequestLogDao();
