 ...
 * @version 	$Id: Widget.php 2391 2010-04-18 06:02:42Z huuphuoc $
 */
...
class Tomato_Modules_Comment_Widgets_Comment_Widget extends Tomato_Core_Widget 
{
	protected function _prepareShow() 
	{
		...
		$comments 		= $commentDao->getThreadComments($start, $perPage, $pageUrl, true);
		...
		$this->_view->assign('numComments', $numComments);
...
//			}
			if ($ok) {
				...
				$redirector->gotoUrl($this->_view->APP_URL.$pageUrl.'#commentForm');
			}
		}
