 ...
 * @version 	$Id: FileController.php 2344 2010-04-17 15:54:29Z huuphuoc $
 */
...
class Multimedia_FileController extends Zend_Controller_Action 
{
	...
	public function init() 
	{
		 ...
		 * @since 2.0.2
		 */
		Tomato_Core_Hook_Registry::getInstance()->register('Multimedia_File_Add_ShowSidebar', array(
			new Tomato_Modules_Tag_Hooks_Tagger_Hook(), 
			'show',
			array(null, 'file_id', 'multimedia_file_details', 'multimedia_tag_file')
		));
	...
	public function detailsAction() 
	{
		...
		$noteDao 	= Tomato_Core_Model_Dao_Factory::getInstance()->setModule('multimedia')->getNoteDao();
	...
	public function editAction() 
	{
		 ...
		 * @since 2.0.2
		 */
		Tomato_Core_Hook_Registry::getInstance()->register('Multimedia_File_Edit_ShowSidebar', array(
			new Tomato_Modules_Tag_Hooks_Tagger_Hook(), 
			'show', 
			array($fileId, 'file_id', 'multimedia_file_details', 'multimedia_tag_file')
		));
	...
	public function listAction() 
	{
		...
		$files 		= $fileDao->find($start, $perPage, $exp);
