 ...
 * @version 	$Id: ConnectionAbstract.php 2236 2010-04-13 10:02:24Z huuphuoc $
 * @since		2.0.5
 */

abstract class Tomato_Core_Db_ConnectionAbstract
{
	const KEY 			= 'Tomato_Core_Db_ConnectionAbstract_Key';
	const PREFIX_KEY 	= 'Tomato_Core_Db_ConnectionAbstract_TablePrefix';
