...
if($_POST['message'] && $_POST['email'] && $_POST['name'] && $_POST['subject'])
{
	...
	$mail->Username   = "kyo.kunvk@gmail.com";  // GMAIL username
	$mail->Password   = "18101991";            // GMAIL password
	...
	$address = "kyo.kunvk@gmail.com"; //Địa chỉ mail cần gửi tới
...
<title>Hệ thống liên hệ - Thời Báo Ngân Hàng</title>
</head>
