 ...
 * @version 	$Id: ad.js 2396 2010-04-18 06:48:08Z huuphuoc $
 */
		...
		switch (this._options['format']) {
			case 'image':
				...
				if (Tomato.Ad.Banner.ALTERNATE_MODE == this._options['mode']) {
					ret += '<img style="border: none;" src="' + this._options['imageUrl'] + '" /></a>';
				} else {
					ret += '<img style="border: none;" src="' + this._options['imageUrl'] + '" width="' + this._zone.getWidth() + '" height="' + this._zone.getHeight() + '" /></a>';
				}
				return ret;
				break;
			case 'flash':
...
Tomato.Ad.Loader = function(zoneId, containerId, url) {
	this._zoneId 		= zoneId;
